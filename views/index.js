...
function editor () {
  return html`
    ...
    <div class="side-by-side center">
      <button class="seek-button seek-back-4">30</button>
      <button class="seek-button seek-back-4">10</button>
      <button class="seek-button seek-back-4">5</button>
      ...
      <button class="seek-button seek-4">5</button>
      <button class="seek-button seek-4">30</button>
    </div>
